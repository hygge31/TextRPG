...
namespace TextRPG
{
    public class Merchant
    {
        ...
        void Init()
        {
            ...
            EquipItem item1 = new EquipItem("Weapon", new StringBuilder("나무 검"), 4, 0, false, "나무를 깎아만든 검이다.", 200);
            EquipItem item2 = new EquipItem("Weapon", new StringBuilder("낡은 철 검"), 6, 0, false, "녹이 쓴 낡은 철검이다.", 400);
            EquipItem item3 = new EquipItem("Weapon", new StringBuilder("뇌진도"), 9, 0, false, "번개 맞은 나무로 만든 단단한 목검이다.", 850);
            EquipItem item7 = new EquipItem("Weapon", new StringBuilder("철 검"), 11, 0, false, "단단한 철검이다.", 1700);
            EquipItem item8 = new EquipItem("Weapon", new StringBuilder("도깨비 방망이"), 19, 0, false, "날카로운 가시가 박힌 쇠 몽둥이이다.", 3500);
            EquipItem item4 = new EquipItem("Armor", new StringBuilder("낡은 가죽 상의"), 0, 4, false, "질긴 소가죽으로 만든 낡은 가죽 옷이다.", 500);
            EquipItem item5 = new EquipItem("Armor", new StringBuilder("무쇠 갑옷"), 0, 9, false, "무쇠로 만든 무겁지만 단단한 갑옷이다.", 1000);
            EquipItem item9 = new EquipItem("Armor", new StringBuilder("강인한자의 팬티"), 0, 20, false, "강한자의 의지가 담긴 팬티이다.", 3000);
            EquipItem item10 = new EquipItem("Armor", new StringBuilder("강화 철제 갑옷"), 0, 40, false, "한층 강화된 철제 갑옷이다.", 5000);
            EquipItem item6 = new EquipItem("Armor", new StringBuilder("비키니"), 0, 600, false, "이상하게 방어력이 높다.", 657450);
