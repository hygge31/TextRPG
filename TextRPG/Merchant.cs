...
namespace TextRPG
{
    public class Merchant
    {
        ...
        void Init()
        {
            ...
            EquipItem item9 = new EquipItem(ItemCategory.Weapon, new StringBuilder("강인한자의 팬티"), 0,20, false, "강한자의 의지가 담긴 팬티이다.", 3000);
            EquipItem item10 = new EquipItem(ItemCategory.Weapon, new StringBuilder("강화 철제 갑옷"), 0, 40, false, "한층 강화된 철제 갑옷이다.", 5000);
